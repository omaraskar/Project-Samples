...
!wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww!
      ...
      SUBROUTINE input(No_vp,No_cp,No_wb,No_hb,No_qb,No_sp,&
                       nbe,xv,yv,zbv)                  
...
!     |________________________________________________________|
      ...
      real*8,dimension(:,:) :: alphasnp,usnp,vsnp,wsnp,psnp
      real*8,dimension(:)   :: eta                  
      real*8,dimension(:,:) :: alphaf,uf,vf,wf,pf                     
      real*8,dimension(:,:) :: alphas,us,vs,ws,ps
      real*8,dimension(:)   :: etav
      real*8,dimension(:,:) :: alphafv,ufv,vfv,wfv,pfv
      real*8,dimension(:,:) :: alphasv,usv,vsv,wsv,psv
      real*8,dimension(:,:) :: Dpfnp,Dpf,Dpfv
      real*8,dimension(:,:) :: rhof,viscof
      real*8,dimension(:,:) :: rhos,viscos
      real*8,dimension(:,:) :: rhofv,viscofv
      real*8,dimension(:,:) :: rhosv,viscosv
      real*8,dimension(:)   :: Hpr,h,wfsurf,wssurf
      real*8,dimension(:)   :: Hprv,hv,wfsurfv,wssurfv
      real*8,dimension(:)   :: xc,yc,sig,dsig
      real*8,dimension(:)   :: xv,yv,sigv,dsigv
      integer,dimension(:,:):: No_cp,No_vp
      integer,dimension(:)  :: nbe,nbev 
