...
!wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww!
      ...
      SUBROUTINE FS_diffusion(Am0,Am1,Am2,Am3,AmT,AmB,            &
                             Bmv1T,Bmv2T,Bmv3T,                   &
                             Bmv1B,Bmv2B,Bmv3B, &
                             Gamx,Gamy,Gamz,                      &
...
!           sigma (interface)
            ...
            Gamsig = Gamzij*(sigzij**2)
!           _______________________________
!           Coefficients
!           -------------------------------
!           Matrix coeff. cell-center i
            AA0 = (Gamsig*sumaiz)*nzAreaFaceij +AA0        		
!           -------------------------------
!           Matrix coeff. cell-center j=T  
            AAT = (Gamsig*sumajz)*nzAreaFaceij
!           -------------------------------
!           Matrix coeff. vertices
	    Bv1T = (Gamsig*fv1Tz)*nzAreaFaceij + Bv1T
	    Bv2T = (Gamsig*fv2Tz)*nzAreaFaceij + Bv2T
	    Bv3T = (Gamsig*fv3Tz)*nzAreaFaceij + Bv3T
!           __________________________________________________________
!          |                                                          |
!          |----------------------------------------------------------|
...
!           Matrix coeff. cell-center j=B  
            AAB = (Gamsig*sumajz)*nzAreaFaceij
!           -------------------------------
!           Matrix coeff. vertices
	    Bv1B = (Gamsig*fv1Tz)*nzAreaFaceij + Bv1B
	    Bv2B = (Gamsig*fv2Tz)*nzAreaFaceij + Bv2B
	    Bv3B = (Gamsig*fv3Tz)*nzAreaFaceij + Bv3B
!           __________________________________________________________
!          |                                                          |
!          |----------------------------------------------------------|
