...
!wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww!
      ...
      SUBROUTINE FS_testTimeError(ufnp,ufnpE,Erruf,ufv,ufvE,Errufv,    &
...
!        Display solution 
         if (DisplayThis.eq.1) then
            ...
            if (s.eq.3) write(*,9) ' w ',maxErrorA,sumErrorA,&
                                         maxErrorR,sumErrorR
            if (s.eq.4) write(*,9) 'eta',maxErrorA,sumErrorA,&
                                         maxErrorR,sumErrorR
         endif
      ENDDO
      if (DisplayThis.eq.1) then
