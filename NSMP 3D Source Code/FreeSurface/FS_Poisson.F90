...
!wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww!
      ...
      SUBROUTINE FS_Poisson(phi,phiv,                      &
                            rhs,Gamx,Gamy,Gamz,            & 
...
!     --------------------------------------
      ...
      integer:: jv1,jv2,jv3
!     --------------------------------------
      real*8  :: errorsys,residu,som,Vol,errorNeum,errorsysOld
      integer :: iter

!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#     ifdef KeyDbg
         write(*,'(t5,60a)'), '<---- Begin subroutine: FS_Poisson'
#     endif
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!     Boundary Condition of the cell-center points  
      call FS_BCpc(phi,xc,yc,sig,dsig,No_cp,nbe,Hpr,h,etan,rhof,dwfdtB)
...
!     Boundary Conditions of the vertex points 
      call FS_BCpv(phiv,xv,yv,sigv,dsigv,No_vp,nbev,Hprv,hv,etav,&
...
!     |________________________________________________________|
      ...
      elseif(iter.gt.MaxIters) then
         ...
         !if (0.eq.mod(iter,1000)) print*, 'iter=',iter,'Error=',errorsys
         goto 111
      endif
...
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#     ifdef KeyDbg
         write(*,'(t5,60a)'), '<---- End   subroutine: FS_Poisson'
#     endif
!     ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
