...
!*********************************************************************!
!                                                                     !
!       Stop criteria to input box conditions (mass calculation)      !
!                                                                     !
!*********************************************************************!

!      ________________________________________________________
!     |                                                        |
!     |           CASE:  Sediment release problem              |
!     |________________________________________________________|
...
#     ifndef KeyParallel
         ...
         do i=1,N_CELL0
            do k=1,NZ-1
               rmass = rmass + rhos(i,k)*alphas(i,k)*&
                               areaCELL(i)*dsig(k)*Hpr(i)
            enddo
         enddo
#     endif
!     ====================================
!     =====  START PARALLEL OPTION =======
#     ifdef KeyParallel
	 call mass_parallel(rmass,som_mass)
	 rmass=som_mass
#     endif
!     =============== END ================    
!     ====================================
...
!      __________________________________
!     |                                  |
!     |    Criteria to stop box input    |
!     |__________________________________| 

         if (rmass.ge.rmassrejet) then
            do k=1,NZ
               do i=1,N_CELL0
                  mask(i,k) = 0.0d0
               enddo
